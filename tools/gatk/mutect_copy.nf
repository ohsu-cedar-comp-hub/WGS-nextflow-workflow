...
process MUTECT2 {
    ...
    output:
    path "${sample_id}_unfiltered.vcf", emit: vcf
    path "${sample_id}_f1r2.tar.gz", emit: f1r2
    path "${sample_id}_unfiltered.vcf.stats", emit: stats
