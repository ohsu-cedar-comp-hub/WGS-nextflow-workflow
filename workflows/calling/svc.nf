...
tumor_ch = Channel.fromPath("${params.outdir}/aligned/duplicate_marked/*_${params.tumor_name}_*.bam")
tumor_ch_bai = Channel.fromPath("${params.outdir}/aligned/duplicate_marked/*_${params.tumor_name}_*.bam.bai")
normal_ch = Channel.fromPath("${params.outdir}/aligned/duplicate_marked/*_${params.normal_name}_*.bam")
normal_ch_bai = Channel.fromPath("${params.outdir}/aligned/duplicate_marked/*_${params.normal_name}_*.bam.bai")
